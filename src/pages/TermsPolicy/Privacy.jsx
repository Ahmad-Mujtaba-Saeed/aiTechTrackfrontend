            ...
            <Card className="shadow-sm mb-4">
                <Card.Body className="p-4">
                    <p className="mb-4">
                        ...
                        when you use Pathforge services. It also outlines your legal rights
                        under the UK General Data Protection Regulation (UK GDPR) and the Data
                        Protection Act 2018.
                    </p>
                    <p>
                        Pathforge Ltd is registered as a Data Controller with the Information
                ...
                <Accordion.Item eventKey="4">
                    ...
                    <Accordion.Body>
                        ...
                        <p className="mt-3">
                            ...
                            <a href="mailto:hello@Pathforge.uk">hello@Pathforge.uk</a>
                        </p>
                    </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="9">
                    ...
                    <Accordion.Body>
                        ...
                        <address>
                            ...
                            Pathforge Ltd<br />
                            Email: <a href="mailto:hello@pathforge.uk">hello@Pathforge.uk</a>
                        </address>
                        <p className="mt-3">
